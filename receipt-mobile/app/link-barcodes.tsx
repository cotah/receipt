...
const styles = StyleSheet.create({
  ...
  pointsBox: { backgroundColor: 'rgba(80,200,120,0.12)', borderRadius: 16, paddingHorizontal: 24, paddingVertical: 14, alignItems: 'center', marginBottom: 16 },
  pointsValue: { fontFamily: Fonts.bodyBold, fontSize: 28, color: '#7DDFAA' },
  pointsSub: { fontFamily: Fonts.body, fontSize: 12, color: '#7DDFAA', marginTop: 2 },
  ...
  linkedCheck: { fontFamily: Fonts.bodyBold, fontSize: 14, color: '#7DDFAA' },
  linkedMore: { fontFamily: Fonts.body, fontSize: 13, color: Colors.text.secondary, marginTop: 4, textAlign: 'center' },
  doneBtn: { backgroundColor: 'rgba(80,200,120,0.2)', borderRadius: 12, paddingHorizontal: 32, paddingVertical: 14, borderWidth: 0.5, borderColor: 'rgba(80,200,120,0.3)' },
