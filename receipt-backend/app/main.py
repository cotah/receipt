...
from app.api.v1 import receipts, products, prices, chat, alerts, reports, leaflets, users, admin, payments, deals, shopping_list, feedback, raffle
...
app.include_router(raffle.router, prefix="/api/v1")
